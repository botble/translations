...
return [
    ...
    'accepted_if' => 'Samþykkja verður þennan reit þegar :other er :value.',
    ...
    'any_of' => 'Þessi reitur er ógildur.',
    'array' => 'Þetta sviði verður að vera fylki.',
    'ascii' => 'Þessi reitur má aðeins innihalda eins-bæta tölustafi og tákn.',
    ...
    'can' => 'Þessi reitur inniheldur óheimilt gildi.',
    'confirmed' => 'Staðfestingu passar ekki.',
    'contains' => 'Áskilið gildi vantar í þennan reit.',
    ...
    'decimal' => 'Þessi reitur verður að hafa :decimal aukastafi.',
    'declined' => 'Þessu gildi verður að hafna.',
    'declined_if' => 'Þessu gildi verður að hafna þegar :other er :value.',
    ...
    'doesnt_contain' => 'Þessi reitur má ekki innihalda neitt af eftirfarandi: :values.',
    'doesnt_end_with' => 'Þessi reitur má ekki enda á einu af eftirfarandi: :values.',
    'doesnt_start_with' => 'Þessi reitur má ekki byrja á einu af eftirfarandi: :values.',
    'email' => 'Þetta hlýtur að vera gild netfangið.',
    'ends_with' => 'Þetta verður að enda með eftirfarandi: :values.',
    'enum' => 'Valið gildi er ekki á lista yfir leyfð gildi.',
    'exists' => 'Valið gildi er ógilt.',
    'extensions' => 'Þessi reitur verður að hafa eina af eftirfarandi viðbótum: :values.',
    'file' => 'Efni verður að vera á skrá.',
    ...
    'numeric' => 'Þetta hlýtur að vera númer.',
    'string' => 'Þetta hlýtur að vera band.',
    'hex_color' => 'Þessi reitur verður að vera gildur sextándabilslitur.',
    'image' => 'Þetta hlýtur að vera mynd.',
    'in' => 'Valið gildi er ógilt.',
    'in_array' => 'Þetta gildi er ekki til í :other.',
    'in_array_keys' => 'Þessi reitur verður að innihalda að minnsta kosti einn af eftirfarandi lyklum: :values.',
    ...
    'list' => 'Þessi reitur verður að vera listi.',
    'lowercase' => 'Þessi reitur verður að vera lítill.',
    'array' => 'Þetta sviði verður að vera fylki.',
    'file' => 'Efni verður að vera á skrá.',
    'numeric' => 'Þetta hlýtur að vera númer.',
    'string' => 'Þetta hlýtur að vera band.',
    ...
    'numeric' => 'Þetta hlýtur að vera númer.',
    'string' => 'Þetta hlýtur að vera band.',
    'mac_address' => 'Gildið verður að vera gilt MAC-vistfang.',
    'array' => 'Þetta sviði verður að vera fylki.',
    'file' => 'Efni verður að vera á skrá.',
    'numeric' => 'Þetta hlýtur að vera númer.',
    'string' => 'Þetta hlýtur að vera band.',
    'max_digits' => 'Þessi reitur má ekki innihalda fleiri en :max tölustafi.',
    ...
    'numeric' => 'Þetta hlýtur að vera númer.',
    'string' => 'Þetta hlýtur að vera band.',
    'min_digits' => 'Þessi reitur verður að hafa að minnsta kosti :min tölustafi.',
    'missing' => 'Þennan reit hlýtur að vanta.',
    'missing_if' => 'Þennan reit verður að vanta þegar :other er :value.',
    'missing_unless' => 'Þennan reit verður að vanta nema :other sé :value.',
    'missing_with' => 'Þennan reit verður að vanta þegar :values er til staðar.',
    'missing_with_all' => 'Þennan reit verður að vanta þegar :values eru til staðar.',
    ...
    'present_if' => 'Þessi reitur verður að vera til staðar þegar :other er :value.',
    'present_unless' => 'Þessi reitur verður að vera til staðar nema :other sé :value.',
    'present_with' => 'Þessi reitur verður að vera til staðar þegar :values er til staðar.',
    'present_with_all' => 'Þessi reitur verður að vera til staðar þegar :values eru til staðar.',
    'prohibited' => 'Þetta sviði er bannað.',
    'prohibited_if' => 'Þetta sviði er bannað þegar :other er :value.',
    'prohibited_if_accepted' => 'Þessi reitur er bönnuð þegar :other er samþykkt.',
    'prohibited_if_declined' => 'Þetta svið er bannað þegar :other er hafnað.',
    'prohibited_unless' => 'Þetta sviði er bönnuð nema :other er í :values.',
    'prohibits' => 'Þessi reitur bannar :other að vera viðstaddir.',
    'regex' => 'Þessu sniði er ógilt.',
    'required' => 'Þetta sviði er krafist.',
    'required_array_keys' => 'Þessi reitur verður að innihalda færslur fyrir: :values.',
    'required_if' => 'Þetta sviði er krafist þegar :other er :value.',
    'required_if_accepted' => 'Þessi reitur er nauðsynlegur þegar :other er samþykkt.',
    'required_if_declined' => 'Þessi reitur er nauðsynlegur þegar :other er hafnað.',
    ...
    'ulid' => 'Þessi reitur verður að vera gilt ULID.',
    'unique' => 'Þetta hefur nú þegar verið tekin.',
    'uploaded' => 'Þetta tókst ekki að hlaða.',
    'uppercase' => 'Þessi reitur verður að vera hástöfum.',
