...
return [
    ...
    'email' => [
        ...
        'mailer' => '收件人',
        'port' => '港口',
        'port_placeholder' => '例如：587',
        'host' => '主持人',
        'host_placeholder' => '例如：smtp.gmail.com',
        'username' => '使用者名稱',
    ...
    'media' => [
        ...
        'r2_url' => 'R2 网址',
        'r2_endpoint' => 'R2端点',
        'do_spaces_access_key_id' => 'DO 空间访问密钥 ID',
        'do_spaces_secret_key' => 'DO 空间密钥',
        'do_spaces_default_region' => 'DO 空间默认区域',
        'do_spaces_bucket' => 'DO 空间桶',
        'do_spaces_endpoint' => 'DO 空间端点',
        'do_spaces_cdn_enabled' => 'DO Spaces CDN 是否启用？',
        'media_do_spaces_cdn_custom_domain' => 'Do Spaces CDN 自定义域',
        'media_do_spaces_cdn_custom_domain_placeholder' => 'https://your-custom-domain.com',
        'backblaze_access_key_id' => 'Backblaze 访问密钥 ID',
        'backblaze_secret_key' => '逆火秘钥',
        'backblaze_bucket' => '逆火桶',
        'backblaze_default_region' => 'Backblaze 默认区域',
        'backblaze_url' => '逆火网址',
        'backblaze_endpoint' => 'Backblaze 端点',
        'convert_image_to_webp' => '将 JPG、JPEG、PNG 图像转换为 WebP',
        'convert_image_to_webp_helper' => 'WebP 是一种现代图像格式，可为网络上的图像提供卓越的无损和有损压缩。 Chrome、Firefox、Edge 和 Opera 均支持它。上传时图像将转换为 WebP 格式。它仅适用于 JPG、JPEG、PNG 图像。',
        'reduce_large_image_size' => '上传时缩小大图像尺寸',
        'reduce_large_image_size_helper' => '启用后，系统会在上传时缩小大图像的尺寸，适用于 JPG、JPEG、PNG、WebP 图像。图像的最大宽度和高度将调整为您在下面设置的值。',
        ...
        'image_max_width_helper' => '设置图像的最大宽度（以像素为单位）。如果该字段为空，将保留原始宽度。',
        'image_max_height_helper' => '设置图像的最大高度（以像素为单位）。如果该字段为空，将保留原始高度。',
        'customize_upload_path' => '自定义上传路径',
        'customize_upload_path_helper' => '自定义媒体文件的上传路径。默认情况下，系统会将文件上传到“:path”文件夹中。',
        'upload_path' => '上传路径',
        'upload_path_placeholder' => '示例：上传',
        'upload_path_helper' => '该文件夹将在 /public 中创建。默认文件夹是“:folder”。然后它将上传到“/public/:folder”。',
        'upload_path_warning' => '系统不会将现有文件移动到新文件夹。如果要将现有文件移动到新文件夹，则需要手动执行此操作。',
        'convert_file_name_to_uuid' => '将文件名转换为UUID',
        'convert_file_name_to_uuid_helper' => '启用后，系统在上传时会将文件名转换为UUID。它对于防止重复的文件名和提高安全性很有用。',
    ],
    'license' => [
        'purchase_code' => '購買代碼',
        'buyer' => '買家',
    ...
    'cache' => [
        ...
        'form' => [
            ...
            'enable_cache_site_map' => '啟用緩存網站地圖嗎？',
            'cache_time_site_map' => '緩存時間站點地圖（分鐘）',
            'cache_admin_menu_helper' => '缓存管理菜单以优化速度。如果您正在开发或自定义管理菜单，则应禁用此选项。',
            ...
            'cache_front_menu' => '缓存前端菜单',
            'cache_front_menu_helper' => '缓存前端菜单以优化速度',
            'cache_user_avatar' => '缓存用户头像',
            'cache_user_avatar_helper' => '对于没有头像的用户，系统会根据用户名生成头像。头像将被缓存以优化速度并且不会重新生成。',
        ],
    ],
    'appearance' => [
        'title' => '外觀',
