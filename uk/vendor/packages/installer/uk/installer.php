...
return [
    ...
    /**
     *
     * Переклади для сторінки дозволів.
     *
     */
    'permissions' => [
    ...
    /**
     *
     * Переклади для сторінки оточення.
     *
     */
    'environment' => [
        'wizard' => [
    ...
    /**
     * Переклади для сторінки створення облікового запису.
     */
    'createAccount' => [
    ...
    /**
     * Переклади для сторінки ліцензії.
     */
