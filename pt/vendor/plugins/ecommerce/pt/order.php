...
return [
    ...
    'menu' => 'Pedidos',
    'create' => 'Crie um pedido',
    'cancel_error' => 'O pedido está sendo entregue ou não foi concluído',
    'cancel_success' => 'Você cancela o pedido com sucesso',
    ...
    'incomplete_orders_intro_description' => 'Pedido incompleto é um pedido criado quando um cliente adiciona um produto ao carrinho, preenche as informações de compra, mas não conclui o processo de finalização da compra.',
    ...
    'error_when_sending_email' => 'Ocorre um erro ao enviar e-mail',
    'sent_confirmation_email_success' => 'E-mail de confirmação enviado com sucesso!',
    'order_was_sent_to_shipping_team' => 'O pedido foi enviado para a equipe de envio',
    ...
    'cannot_found_payment_for_this_order' => 'Não foi possível encontrar o pagamento para este pedido!',
    'refund_success_with_price' => 'Refund success :price',
    'refund_success' => 'Reembolso com sucesso!',
    'order_is_not_existed' => 'A ordem não existe!',
    'reorder' => 'Reordenar',
    'sent_email_incomplete_order_success' => 'Enviado e-mail para lembrar sobre pedido incompleto com sucesso!',
    'applied_coupon_success' => 'Cupom ":code" aplicado com sucesso!',
    'new_order_notice' => 'Você tem <span class="bold">:count</span> novos pedidos',
    'view_all' => 'Ver tudo',
    ...
    'warehouse' => 'Armazém',
    'sub_amount' => 'Subvalor',
    'coupon_code' => 'Código do cupom: ":código"',
    ...
    'dont_have_an_account_yet' => 'Ainda não tenho uma conta',
    ...
    'resend_order_confirmation_description' => 'O e-mail de confirmação será enviado para <strong>:email</strong>?',
    'send' => 'Enviar',
    'update' => 'Atualizar',
    ...
    'how_to_select_configured_shipping' => 'Como selecionar o frete configurado?',
    ...
    'cash_on_delivery_cod' => 'Pagamento na entrega (COD)',
