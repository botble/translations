...
return [
    ...
    'accepted_if' => 'Medan ini mesti diterima apabila :other ialah :value.',
    ...
    'any_of' => 'Bidang ini tidak sah.',
    'array' => 'Ruangan ini mesti jujukan.',
    'ascii' => 'Medan ini hanya boleh mengandungi aksara dan simbol alfanumerik bait tunggal.',
    ...
    'can' => 'Medan ini mengandungi nilai yang tidak dibenarkan.',
    'confirmed' => 'Pengesahan yang tidak sepadan.',
    'contains' => 'Medan ini tiada nilai yang diperlukan.',
    ...
    'decimal' => 'Medan ini mesti mempunyai :decimal tempat perpuluhan.',
    'declined' => 'Nilai ini mesti ditolak.',
    'declined_if' => 'Nilai ini mesti ditolak apabila :other ialah :value.',
    ...
    'doesnt_contain' => 'Bidang ini tidak boleh mengandungi mana -mana yang berikut: :values.',
    'doesnt_end_with' => 'Medan ini mungkin tidak berakhir dengan salah satu daripada yang berikut: :values.',
    'doesnt_start_with' => 'Medan ini mungkin tidak bermula dengan salah satu daripada yang berikut: :values.',
    'email' => 'Alamat emel mestilah sah.',
    'ends_with' => 'Nilai mesti berakhir dengan salah satu dari nilai berikut: :values.',
    'enum' => 'Nilai yang dipilih tiada dalam senarai nilai yang dibenarkan.',
    'exists' => 'Pilihan tidak sah.',
    'extensions' => 'Medan ini mesti mempunyai salah satu daripada sambungan berikut: :values.',
    'file' => 'Ruangan ini mesti fail yang sah.',
    ...
    'numeric' => 'Nilai mesti nombor.',
    'string' => 'Nilai mesti jujukan.',
    'hex_color' => 'Medan ini mestilah warna perenambelasan yang sah.',
    'image' => 'Nilai mesti imej.',
    'in' => 'Pilihan tidak sah.',
    'in_array' => 'Nilai tidak wujud di :other.',
    'in_array_keys' => 'Bidang ini mesti mengandungi sekurang -kurangnya satu kunci berikut: :values.',
    ...
    'list' => 'Medan ini mestilah senarai.',
    'lowercase' => 'Medan ini mestilah huruf kecil.',
    'array' => 'Ruangan ini mesti jujukan.',
    'file' => 'Ruangan ini mesti fail yang sah.',
    'numeric' => 'Nilai mesti nombor.',
    'string' => 'Nilai mesti jujukan.',
    ...
    'numeric' => 'Nilai mesti nombor.',
    'string' => 'Nilai mesti jujukan.',
    'mac_address' => 'Nilai mesti alamat MAC yang sah.',
    'array' => 'Ruangan ini mesti jujukan.',
    'file' => 'Ruangan ini mesti fail yang sah.',
    'numeric' => 'Nilai mesti nombor.',
    'string' => 'Nilai mesti jujukan.',
    'max_digits' => 'Medan ini tidak boleh mempunyai lebih daripada :max digit.',
    ...
    'numeric' => 'Nilai mesti nombor.',
    'string' => 'Nilai mesti jujukan.',
    'min_digits' => 'Medan ini mesti mempunyai sekurang-kurangnya :min digit.',
    'missing' => 'Medan ini mesti tiada.',
    'missing_if' => 'Medan ini mesti tiada apabila :other ialah :value.',
    'missing_unless' => 'Medan ini mesti tiada melainkan :other ialah :value.',
    'missing_with' => 'Medan ini mesti tiada apabila :values hadir.',
    'missing_with_all' => 'Medan ini mesti tiada apabila :values hadir.',
    ...
    'present_if' => 'Medan ini mesti ada apabila :other ialah :value.',
    'present_unless' => 'Medan ini mesti ada kecuali :other ialah :value.',
    'present_with' => 'Medan ini mesti ada apabila :values hadir.',
    ...
    'required_array_keys' => 'Medan ini mesti mengandungi entri untuk: :values.',
    ...
    'required_if_declined' => 'Medan ini diperlukan apabila :other ditolak.',
    ...
    'ulid' => 'Medan ini mestilah ULID yang sah.',
    'unique' => 'Nilai telah wujud.',
    'uploaded' => 'Muat naik gagal.',
    'uppercase' => 'Medan ini mestilah huruf besar.',
